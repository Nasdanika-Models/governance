 ...
 */
public class GovernanceResourceContentsHandlerCapabilityFactory extends ServiceCapabilityFactory<org.nasdanika.capability.emf.ResourceContentsHandler.Requirement, ResourceContentsHandler<Document>> {
	...
	protected CompletionStage<Iterable<CapabilityProvider<ResourceContentsHandler<Document>>>> createService(
		...
		return wrap(new GovernanceResourceContentsHandler());
	}
